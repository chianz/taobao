...

{
...

    {
        ...
        if ($upRow > 0) {
            ...
            $upPage = "<li class='prev disabled'><a href='javascript:;'>" . $this->config['prev'] . "</a></li>";
        ...
        if ($downRow <= $this->totalPages) {
            ...
            $downPage = "<li class='next disabled'><a href='javascript:;'>" . $this->config['next'] . "</a></li>";
        ...
        for ($i = 1; $i <= $this->rollPage; $i++) {
            ...
            if ($page != $this->nowPage) {
                ...
                if ($this->totalPages != 1) {
                    ...
                    $linkPage .= "<li class='active'><a href='javascript:;'>" . $page . "</a></li>"; // "<span class='current'>".$page."</span>";
