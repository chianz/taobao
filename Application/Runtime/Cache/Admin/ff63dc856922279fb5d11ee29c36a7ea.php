...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="/index.php/Admin/Ad/index" class="current">广告管理</a>
        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content">
                    <form class="form-horizontal" method="post" action="/index.php/Admin/Ad/update" name="basic_validate" id="basic_validate"
