...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="<?php echo U('Ad/one',array('id'=>$ad['id']));?>"><?php echo ($ad["title"]); ?></a>
            <a href="#" class="current"><?php echo ($ad["title"]); ?>广告管理</a>
        </div>
    </div>
    <div class="widget-content">
        <div><a href="/index.php/Admin/Ad/fone?aid=<?php echo ($ad["id"]); ?>" class="btn btn-success">添加广告</a></div>
        <table class="table">
            <thead>
            <tr>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                    <a href="/index.php/Admin/Ad/fone?id=<?php echo ($vo["id"]); ?>&aid=<?php echo ($vo["ad_id"]); ?>" class="btn btn-primary btn-mini">修改</a>
                    <a href="javascript:if(confirm('确实要删除该内容吗?'))location='/index.php/Admin/Ad/fdel?id=<?php echo ($vo["id"]); ?>&ad_id=<?php echo ($vo["ad_id"]); ?>'" class="btn btn-danger btn-mini">删除</a>
