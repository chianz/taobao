...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="/index.php/Admin/Shopcolumn/index" class="current">商品分类</a>
            <a href="#" class="current"><?php if(empty($one["id"])): ?>添加<?php else: ?>修改<?php echo ($one["title"]); endif; ?>商品分类</a>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content">
                    <form class="form-horizontal" method="post" action="/index.php/Admin/Shopcolumn/update" name="basic_validate" id="basic_validate"
