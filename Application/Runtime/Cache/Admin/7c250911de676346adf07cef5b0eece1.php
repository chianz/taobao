...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="/index.php/Admin/Articlecolumn/index" class="current">文章分类</a>
            <a href="#" class="current"><?php if(empty($one["id"])): ?>添加<?php else: ?>修改<?php echo ($one["title"]); endif; ?>文章分类</a>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"><span class="icon"> <i class="icon-info-sign"></i> </span>
                    <h5>
                        <?php if(empty($one["id"])): ?>添加<?php else: ?>修改<?php echo ($one["title"]); endif; ?>文章分类
                    </h5>
                </div>
                <div class="widget-content">
                    <form class="form-horizontal" method="post" action="/index.php/Admin/Articlecolumn/update" name="basic_validate" id="basic_validate"
...
<script type="text/javascript">
    $(function () {
    	...
    	var files = $(".files");
    	var btn = $(".btn span");
    	$("#fileupload").wrap("<form id='myupload' action='/index.php/Admin/Articlecolumn/upload_img' method='post' enctype='multipart/form-data'></form>");
