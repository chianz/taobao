...
<div id="content">
    ...
    <div class="widget-content">
        <div><a href="/index.php/Admin/Ad/one" class="btn btn-success">添加广告</a></div>
        <table class="table">
            <thead>
            <tr>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php if(($vo["is_show"]) == "0"): ?><span class="color:red">[隐藏]</span><?php endif; echo ($vo["title"]); ?></td>
                    <td><?php echo ($vo["des"]); ?></td>                    
                    <td>
                    
                    <a href="/index.php/Admin/Ad/one?id=<?php echo ($vo["id"]); ?>" class="btn btn-primary btn-mini">修改</a>
                    <a href="javascript:if(confirm('确实要删除该内容吗?'))location='/index.php/Admin/Ad/del?id=<?php echo ($vo["id"]); ?>'" class="btn btn-danger btn-mini">删除</a>
                    <?php if(($vo["is_show"]) == "0"): ?><a href="/index.php/Admin/Ad/show?id=<?php echo ($vo["id"]); ?>" class="btn btn-info btn-mini">显示</a><?php else: ?><a href="/index.php/Admin/Ad/hide?id=<?php echo ($vo["id"]); ?>" class="btn btn-inverse btn-mini">隐藏</a><?php endif; ?>
                    <a href="/index.php/Admin/Ad/flist?id=<?php echo ($vo["id"]); ?>" class="btn btn-warning btn-mini" >查看祥细</a>
                            </td>
