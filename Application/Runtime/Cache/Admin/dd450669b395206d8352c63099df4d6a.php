...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="/index.php/Admin/Ad/index">广告管理</a>
            <a href="<?php echo U('Ad/flist',array('id'=>$ad['id']));?>"><?php echo ($ad["title"]); ?>广告管理</a>
            <a href="#" class="current"><?php if(empty($one["id"])): ?>添加<?php else: ?>修改<?php echo ($one["title"]); endif; ?>广告</a>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"><span class="icon"> <i class="icon-info-sign"></i> </span>
                    <h5>
                        <?php if(empty($one["id"])): ?>添加<?php else: ?>修改<?php echo ($one["title"]); endif; ?>广告
                    </h5>
                </div>
                <div class="widget-content">
                    <form class="form-horizontal" method="post" action="/index.php/Admin/Ad/fupdate" name="basic_validate" id="basic_validate"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="ftitle" value="<?php echo ($one["ftitle"]); ?>">
                            </div>                            
                        </div>
                       <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="sort" value="<?php echo ($one["sort"]); ?>">
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <img id="img" src="<?php echo ((isset($one["img"]) && ($one["img"] !== ""))?($one["img"]):'/Public/Images/default.jpg'); ?>" title="点击上传图片" style="border:1px solid #000;max-widht:200px;">
                                <input type="file" name="mypic" id="fileupload" style="display:none"/>
                                <input type="hidden" name="img" value="<?php echo ((isset($one["img"]) && ($one["img"] !== ""))?($one["img"]):'/Public/Images/default.jpg'); ?>"/>
...
<script type="text/javascript" src="/Application/Admin/View/Pulbic//js/jquery.form.js"></script>
<script type="text/javascript">
    $(function () {
    	...
    	var files = $(".files");
    	var btn = $(".btn span");
    	$("#fileupload").wrap("<form id='myupload' action='/index.php/Admin/Ad/upload_img' method='post' enctype='multipart/form-data'></form>");
