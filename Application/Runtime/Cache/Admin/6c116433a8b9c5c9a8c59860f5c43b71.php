...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="/index.php/Admin/Menu/index" class="current">菜单管理</a>
            <a href="#" class="current"><?php if(empty($one["id"])): ?>添加<?php else: ?>修改<?php echo ($one["title"]); endif; ?>菜单</a>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <div class="widget-box">
                <div class="widget-title"><span class="icon"> <i class="icon-info-sign"></i> </span>
                    <h5>
                        <?php if(empty($one["id"])): ?>添加<?php else: ?>修改<?php echo ($one["title"]); endif; ?>菜单
                    </h5>
                </div>
                <div class="widget-content">
                    <form class="form-horizontal" method="post" action="/index.php/Admin/Menu/update" name="basic_validate" id="basic_validate"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="controller" value="<?php echo ($one["controller"]); ?>">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">function</label>
                            <div class="controls">
                                <input type="text" name="function" value="<?php echo ($one["function"]); ?>">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">parm</label>
                            <div class="controls">
                                <input type="text" name="parm" value="<?php echo ($one["parm"]); ?>">
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select class="selector" name="sid">
                                    ...
                                    <?php $temp=D("menu")->where(["sid"=>0])->select();?>
