...
<div id="content">
    ...
    <div class="widget-content">
        <div><a href="/index.php/Admin/Shop/one" class="btn btn-success">添加商品</a></div>
        <table class="table">
            <thead>
            <tr>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="/index.php/Admin/Shop/one?id=<?php echo ($vo["id"]); ?>" class="btn btn-primary btn-mini">修改</a><a
                            href="javascript:if(confirm('确实要删除该内容吗?'))location='/index.php/Admin/Shop/del?id=<?php echo ($vo["id"]); ?>'"
