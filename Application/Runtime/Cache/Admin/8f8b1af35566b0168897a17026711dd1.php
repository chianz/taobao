        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content">
                    <form class="form-horizontal" method="post" action="/index.php/Admin/Webset/update" name="basic_validate" id="basic_validate"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="key" value="<?php echo ($one["key"]); ?>">
                            </div>
                        </div>
